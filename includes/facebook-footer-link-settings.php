...
function ffl_options_content() {
	...
	<div class="wrap">
		...
		<p><?php _e( 'Settings for Facebook Footer Link Plugin', 'ffl_domain' ); ?></p>
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<input name="ffl_settings[enable]" type="checkbox" id="ffl_settings[enable]"
						       value="1" <?php checked( '1', $ffl_options['enable'] ); ?>
					</td>
				</tr>
				<tr>
					<th scope="row">
					...
					<td>
						<input name="ffl_settings[facebook_url]" type="text" id="ffl_settings[facebook_url]"
				...
				<tr>
					<th scope="row">
						<label for="ffl_settings[link_color]"><?php _e( 'Link Color', 'ffl_domain' ); ?></label></th>
					<td>
						<input name="ffl_settings[link_colour]" type="color" id="ffl_settings[link_colour]"
						       value="<?= $ffl_options['link_colour'] ?>">
